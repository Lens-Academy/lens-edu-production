...
This compute scaling trend has yielded models with ever more useful capabilities. However, these advanced capabilities also bring with them greater dangers from misuse \[[7](https://arxiv.org/html/2303.11341#bib.bibx7)\]. For instance, it is increasingly plausible that criminals may soon be able to leverage heavily-trained code-generation-and-execution models to autonomously identify and exploit cyber-vulnerabilities, enabling ransomware attacks on an unprecedented scale. [^cite-shavit-1] Even absent malicious intent, rival companies or countries trapped in an AI “race dynamic” may face substantial pressure to cut corners on testing and risk-mitigation, in order to deploy high-capability ML systems in the hopes of outmaneuvering their competitors economically or militarily. The edge-case behaviors of deep learning models are notoriously difficult to debug \[[20](https://arxiv.org/html/2303.11341#bib.bibx20)\], and without thorough testing and mitigation, such bugs in increasingly capable systems may have increasingly severe consequences. Even when rival parties would all prefer to individually do more testing and risk-mitigation, or even forgo developing particularly dangerous types of ML models entirely \[[60](https://arxiv.org/html/2303.11341#bib.bibx60)\], they may have no way to verify whether their competitors are matching their levels of caution.
...
In Table [1](#S3.T1 "Table 1 ‣ 3.2 How many ML chips does the Verifier need to inspect? ‣ 3 Solution Overview ‣ A template for Arxiv Style Citation: Authors. Title. Pages…. DOI:000000/11111."), we provide the total required samples-per-year $365\cdot s/T_{m}$ to catch several past and projected training runs, for Provers who own different quantities of chips $C$.
...
| --- | --- | --- | --- | --- | --- | --- |
| GPT-3 \[[6](https://arxiv.org/html/2303.11341#bib.bibx6)\] | 3.14e+23 | 3.64e+3 | 10 | 243 | 2.43e+4 | 2.43e+6 |
| Chinchilla \[[21](https://arxiv.org/html/2303.11341#bib.bibx21)\] | 5.76e+23 | 6.67e+3 | 19 | 132 | 1.33e+4 | 1.33e+6 |
| PaLM \[[10](https://arxiv.org/html/2303.11341#bib.bibx10)\] | 2.56e+24 | 2.96e+4 | 82 | 29 | 2.98e+3 | 2.99e+5 |
...
An obstacle to logging all weight-shards stored in ML device memory is that different ML training code will store a model’s weights in different regions of memory. The chip’s firmware must be able to determine which region of memory the weights are stored in. It may be possible to determine the weight-regions retroactively, by logging the regions of memory claimed to correspond to the weights, along with a copy of the compiled on-device code, which can then be matched to Prover-provided source code and its memory allocation pattern analyzed. [^note-shavit-13] [^note-shavit-14] As a more invasive alternative, the Prover could proactively certify that its chip-level ML training code stores the weights in a specific memory region, by having its chip-code verified and then signed by a Verifier-trusted server before it can be executed by the firmware. [^note-shavit-15]
...
Even if only a subset of responsible companies and governments comply with the framework, they still benefit from verifiably demonstrating their compliance with self-imposed rules by increasing their rivals’ and allies’ confidence in their behavior \[[22](https://arxiv.org/html/2303.11341#bib.bibx22)\] (and thus reducing their rival’s uncertainty and incentive towards recklessness).
...
-   \[4\] Mauricio Baker “Nuclear Arms Control Verification and Lessons for AI Treaties ”, Forthcoming
-   \[5\] “BIS Press Release: Advanced Computing and Semiconductor Manufacturing Controls” In _BIS Press Release Advanced Computing and Semiconductor Manufacturing Controls_ US Department of Commerce Bureau of IndustrySecurity, 2022 URL: [https://www.bis.doc.gov/index.php/documents/about-bis/newsroom/press-releases/3158-2022-10-07-bis-press-release-advanced-computing-and-semiconductor-manufacturing-controls-final/file;](https://www.bis.doc.gov/index.php/documents/about-bis/newsroom/press-releases/3158-2022-10-07-bis-press-release-advanced-computing-and-semiconductor-manufacturing-controls-final/file;)
-   \[6\] Tom Brown et al. “Language Models are Few-Shot Learners” In _Advances in Neural Information Processing Systems_ 33 Curran Associates, Inc., 2020, pp. 1877–1901 URL: [https://proceedings.neurips.cc/paper/2020/file/1457c0d6bfcb4967418bfb8ac142f64a-Paper.pdf](https://proceedings.neurips.cc/paper/2020/file/1457c0d6bfcb4967418bfb8ac142f64a-Paper.pdf)
-   \[7\] Miles Brundage et al. “The Malicious Use of Artificial Intelligence: Forecasting, Prevention, and Mitigation” arXiv, 2018 DOI: [10.48550/ARXIV.1802.07228](https://dx.doi.org/10.48550/ARXIV.1802.07228)
-   \[8\] US Census Bureau “Federal Statistical Research Data Centers” In _Census.gov_, 2022 URL: [https://www.census.gov/about/adrm/fsrdc.html](https://www.census.gov/about/adrm/fsrdc.html)
-   \[9\] Piljoo Choi and Dong Kyue Kim “Design of security enhanced TPM chip against invasive physical attacks” In _2012 IEEE International Symposium on Circuits and Systems (ISCAS)_, 2012, pp. 1787–1790 DOI: [10.1109/ISCAS.2012.6271612](https://dx.doi.org/10.1109/ISCAS.2012.6271612)
-   \[10\] Aakanksha Chowdhery et al. “PaLM: Scaling Language Modeling with Pathways” arXiv, 2022 DOI: [10.48550/ARXIV.2204.02311](https://dx.doi.org/10.48550/ARXIV.2204.02311)
-   \[11\] Keith Chu “Wyden, Booker and Clarke Introduce Algorithmic Accountability Act of 2022 to require new transparency and accountability for Automated Decision Systems” In _U.S. Senator Ron Wyden of Oregon_, 2022 URL: [https://www.wyden.senate.gov/news/press-releases/wyden-booker-and-clarke-introduce-algorithmic-accountability-act-of-2022-to-require-new-transparency-and-accountability-for-automated-decision-systems](https://www.wyden.senate.gov/news/press-releases/wyden-booker-and-clarke-introduce-algorithmic-accountability-act-of-2022-to-require-new-transparency-and-accountability-for-automated-decision-systems)
-   \[12\] Bonnie Docherty “New Weapons, Proven Precedent: Elements of and Models for a Treaty on Killer Robots” In _Human Rights Watch_ Human Rights Watch, 2020 URL: [https://www.hrw.org/report/2020/10/20/new-weapons-proven-precedent/elements-and-models-treaty-killer-robots](https://www.hrw.org/report/2020/10/20/new-weapons-proven-precedent/elements-and-models-treaty-killer-robots)
-   \[13\] Olivia J Erdélyi and Judy Goldsmith “Regulating Artificial Intelligence: Proposal for a Global Solution” In _Proceedings of the 2018 AAAI/ACM Conference on AI, Ethics, and Society_, 2018, pp. 95–101
-   \[14\] Ege Erdil and Tamay Besiroglu “Algorithmic Progress in Computer Vision” arXiv, 2022 DOI: [10.48550/ARXIV.2212.05153](https://dx.doi.org/10.48550/ARXIV.2212.05153)
-   \[15\] Congyu Fang et al. “On the Fundamental Limits of Formally (Dis) Proving Robustness in Proof-of-Learning” In _arXiv preprint arXiv:2208.03567_, 2022
-   \[16\] Deep Ganguli et al. “Predictability and Surprise in Large Generative Models” In _2022 ACM Conference on Fairness, Accountability, and Transparency_, 2022, pp. 1747–1764
-   \[17\] Chaim Gartenberg “NVIDIA Has Reinstated its RTX 3060 Ethereum Cryptocurrency Mining Limit” In _The Verge_ The Verge, 2021 URL: [https://www.theverge.com/2021/4/29/22409838/nvidia-rtx-3060-etherium-cryptocurrency-mining-limit-back-driver-update](https://www.theverge.com/2021/4/29/22409838/nvidia-rtx-3060-etherium-cryptocurrency-mining-limit-back-driver-update)
-   \[18\] Andy Greenberg “The Untold Story of NotPetya, the Most Devastating Cyberattack in History” In _Wired_ Conde Nast, 2018 URL: [https://www.wired.com/story/notpetya-cyberattack-ukraine-russia-code-crashed-the-world/](https://www.wired.com/story/notpetya-cyberattack-ukraine-russia-code-crashed-the-world/)
-   \[19\] R JS Harry “IAEA Safeguards and Detection of Undeclared Nuclear Activities”, 1996
-   \[20\] Dan Hendrycks, Nicholas Carlini, John Schulman and Jacob Steinhardt “Unsolved Problems in ML Safety” In _arXiv preprint arXiv:2109.13916_, 2021
-   \[21\] Jordan Hoffmann et al. “Training Compute-Optimal Large Language Models” arXiv, 2022 DOI: [10.48550/ARXIV.2203.15556](https://dx.doi.org/10.48550/ARXIV.2203.15556)
-   \[22\] Michael C Horowitz “AI and International Stability: Risks and Confidence-Building Measures” Center for a New American Security, 2021
-   \[23\] Tim Hwang “Computational Power and the Social Impact of Artificial Intelligence” In _arXiv preprint arXiv:1803.08971_, 2018
-   \[24\] Hengrui Jia et al. “Proof-of-Learning: Definitions and Practice” In _2021 IEEE Symposium on Security and Privacy (SP)_, 2021, pp. 1039–1056 IEEE
-   \[25\] Jared Kaplan et al. “Scaling Laws for Neural Language Models” arXiv, 2020 DOI: [10.48550/ARXIV.2001.08361](https://dx.doi.org/10.48550/ARXIV.2001.08361)
-   \[26\] Diederik P. Kingma and Jimmy Ba “Adam: A Method for Stochastic Optimization” In _3rd International Conference on Learning Representations, ICLR 2015, San Diego, CA, USA, May 7-9, 2015, Conference Track Proceedings_, 2015 URL: [http://arxiv.org/abs/1412.6980](http://arxiv.org/abs/1412.6980)
-   \[27\] Paul C. Kocher “Timing Attacks on Implementations of Diffie-Hellman, RSA, DSS, and Other Systems” In _Advances in Cryptology - CRYPTO ’96, 16th Annual International Cryptology Conference, Santa Barbara, California, USA, August 18-22, 1996, Proceedings_ 1109, Lecture Notes in Computer Science Springer, 1996, pp. 104–113 DOI: [10.1007/3-540-68697-5\_9](https://dx.doi.org/10.1007/3-540-68697-5_9)
-   \[28\] Srilehka Krishnamurthy, Jeremy O’Donoghue and Neeraj Bhatia “US20140130151A1 - Methods for Providing Anti-Rollback Protection of a Firmware Version in a Device Which Has No Internal Non-Volatile Memory” In _Google Patents_ Google, 2012 URL: [https://patents.google.com/patent/US20140130151A1/en](https://patents.google.com/patent/US20140130151A1/en)
-   \[29\] Frederic Lardinois “Google Launches a 9 Exaflop Cluster of Cloud TPU V4 Pods Into Public Preview” In _TechCrunch_, 2022 URL: [https://techcrunch.com/2022/05/11/google-launches-a-9-exaflop-cluster-of-cloud-tpu-v4-pods-into-public-preview/](https://techcrunch.com/2022/05/11/google-launches-a-9-exaflop-cluster-of-cloud-tpu-v4-pods-into-public-preview/)
-   \[30\] Seunghwa Lee, Hankyung Ko, Jihye Kim and Hyunok Oh “VCNN: Verifiable convolutional neural network based on ZK-Snarks” In _Cryptology ePrint Archive_, 2020
-   \[31\] “Lightweight Threat Model: OpenTitan documentation” In _Lightweight Threat Model | OpenTitan Documentation_ OpenTitan URL: [https://docs.opentitan.org/doc/security/threat\_model/](https://docs.opentitan.org/doc/security/threat_model/)
-   \[32\] “List of Semiconductor Fabrication Plants” In _Wikipedia_ Wikimedia Foundation, 2023 URL: [https://en.wikipedia.org/wiki/List\_of\_semiconductor\_fabrication\_plants](https://en.wikipedia.org/wiki/List_of_semiconductor_fabrication_plants)
-   \[33\] Chao Liu et al. “On the Reproducibility and Replicability of Deep Learning in Software Engineering” In _ACM Transactions on Software Engineering and Methodology (TOSEM)_ 31.1 ACM New York, NY, 2021, pp. 1–46
-   \[34\] Yingqi Liu et al. “Trojaning Attack on Neural Networks”, 2017
-   \[35\] Ali Madani et al. “Large Language Models Generate Functional Protein Sequences Across Diverse Families” In _Nature Biotechnology_ Nature Publishing Group US New York, 2023, pp. 1–8
-   \[36\] Lucie Charlotte Magister et al. “Teaching Small Language Models to Reason” arXiv, 2022 DOI: [10.48550/ARXIV.2212.08410](https://dx.doi.org/10.48550/ARXIV.2212.08410)
-   \[37\] Matt Mittelsteadt “AI Verification-Mechanisms to Ensure AI Arms Control Compliance” SPL: Institute for Security PolicyLaw, 2021
-   \[38\] Sebastian Moss “NVIDIA Updates GeForce EULA to Prohibit Data Center Use” In _Datacenter Dynamics_, 2023 URL: [https://www.datacenterdynamics.com/en/news/nvidia-updates-geforce-eula-to-prohibit-data-center-use/](https://www.datacenterdynamics.com/en/news/nvidia-updates-geforce-eula-to-prohibit-data-center-use/)
-   \[39\] Patricia Musoke-Zawedde and Teodor Nicula-Golovei “A Day in the Life of a Nuclear Safeguards Inspector” In _IAEA_ IAEA, 2022 URL: [https://www.iaea.org/bulletin/a-day-in-the-life-of-a-nuclear-safeguards-inspector](https://www.iaea.org/bulletin/a-day-in-the-life-of-a-nuclear-safeguards-inspector)
-   \[40\] “Nuclear Power by Country” In _Wikipedia_ Wikimedia Foundation, 2023 URL: [https://en.wikipedia.org/wiki/Nuclear\_power\_by\_country](https://en.wikipedia.org/wiki/Nuclear_power_by_country)
-   \[41\] “NVIDIA GeForce RTX 4090 graphics cards” In _NVIDIA_ URL: [https://www.nvidia.com/en-us/geforce/graphics-cards/40-series/rtx-4090/](https://www.nvidia.com/en-us/geforce/graphics-cards/40-series/rtx-4090/)
-   \[42\] “Nvidia H100 Tensor Core GPU Architecture Overview” In _NVIDIA_ URL: [https://resources.nvidia.com/en-us-tensor-core](https://resources.nvidia.com/en-us-tensor-core)
-   \[43\] Cyberspace Administration China “Translation of "Provisions on the Management of Algorithmic Recommendations in Internet Information Services"” In _China Law Translate_ China Law Translate, 2022 URL: [https://www.chinalawtranslate.com/en/algorithms/](https://www.chinalawtranslate.com/en/algorithms/)
-   \[44\] Thomas Pledger “The Role of Drones in Future Terrorist Attacks” In _Association of the United States army_ 26, 2021
-   \[45\] Open Compute Project “Caliptra RTM Technical Specification” In _Caliptra: A Datacenter System on a Chip (SOC) Root of Trust (RoT)_, 2022 URL: [https://www.opencompute.org/documents/caliptra-silicon-rot-services-09012022-pdf](https://www.opencompute.org/documents/caliptra-silicon-rot-services-09012022-pdf)
-   \[46\] Andrew W Reddie “Governing Insecurity: Institutional Design, Compliance, and Arms Control” University of California, Berkeley, 2019
-   \[47\] Thomas Reinhold “Arms Control for Artificial Intelligence” In _Armament, Arms Control and Artificial Intelligence: The Janus-faced Nature of Machine Learning in the Military Realm_ Springer, 2022, pp. 211–226
-   \[48\] Jordan Robertson and Michael Riley “Supermicro Hack: How China exploited a U.S. Tech supplier over years” In _Bloomberg.com_ Bloomberg, 2021 URL: [https://www.bloomberg.com/features/2021-supermicro/](https://www.bloomberg.com/features/2021-supermicro/)
-   \[49\] Jonathan S. Rosenfeld “Scaling Laws for Deep Learning” In _CoRR_ abs/2108.07686, 2021 arXiv: [https://arxiv.org/abs/2108.07686](https://arxiv.org/abs/2108.07686)
-   \[50\] Max Ryabinin, Tim Dettmers, Michael Diskin and Alexander Borzunov “SWARM Parallelism: Training Large Models Can Be Surprisingly Communication-Efficient” arXiv, 2023 DOI: [10.48550/ARXIV.2301.11913](https://dx.doi.org/10.48550/ARXIV.2301.11913)
-   \[51\] Girish Sastry, Miles Brundage, Julian Hazell and et al. Anderljung “Computing Power and the Governance of Artificial Intelligence ”, Forthcoming
-   \[52\] Paul Scharre and Megan Lamberth “Artificial Intelligence and Arms Control” In _arXiv preprint arXiv:2211.00065_, 2022
-   \[53\] Lisa M Schenck and Robert A Youmans “From Start to Finish: A Historical Review of Nuclear Arms Controls Treaties and Starting over with the New Start” In _Cardozo J. Int’l & Comp. L._ 20 HeinOnline, 2011, pp. 399
-   \[54\] Jaime Sevilla et al. “Compute Trends Across Three Eras of Machine Learning” In _2022 International Joint Conference on Neural Networks (IJCNN)_, 2022, pp. 1–8 IEEE
-   \[55\] Ying Sheng et al. “High-throughput Generative Inference of Large Language Models with a Single GPU” In _arXiv preprint arXiv:2303.06865_, 2023
-   \[56\] Sergei P Skorobogatov “Semi-invasive Attacks–A New Approach to Hardware Security Analysis”, 2005
-   \[57\] Shaden Smith et al. “Using DeepSpeed and Megatron to Train Megatron-Turing NLG 530B, A Large-Scale Generative Language Model” arXiv, 2022 DOI: [10.48550/ARXIV.2201.11990](https://dx.doi.org/10.48550/ARXIV.2201.11990)
-   \[58\] Irene Solaiman “The Gradient of Generative AI Release: Methods and Considerations” In _arXiv preprint arXiv:2302.04844_, 2023
-   \[59\] Richard Sutton “The Bitter Lesson” In _Incomplete Ideas (blog)_ 13.1, 2019
-   \[60\] Fabio Urbina, Filippa Lentzos, Cédric Invernizzi and Sean Ekins “Dual Use of Artificial-Intelligence-Powered Drug Discovery” In _Nature Machine Intelligence_ 4.3 Nature Publishing Group UK London, 2022, pp. 189–191
-   \[61\] Michael Veale and Frederik Zuiderveen Borgesius “Demystifying the Draft EU Artificial Intelligence Act—Analysing the good, the bad, and the unclear elements of the proposed approach” In _Computer Law Review International_ 22.4 Verlag Dr. Otto Schmidt, 2021, pp. 97–112
-   \[62\] Pablo Villalobos “Scaling Laws Literature Review” Accessed: 2023-02-03, [https://epochai.org/blog/scaling-laws-literature-review](https://epochai.org/blog/scaling-laws-literature-review), 2023
-   \[63\] Sameer Wagh, Divya Gupta and Nishanth Chandran “SecureNN: Efficient and private neural network training” In _Cryptology ePrint Archive_, 2018
-   \[64\] Adam Waksman and Simha Sethumadhavan “Tamper Evident Microprocessors” In _2010 IEEE Symposium on Security and Privacy_, 2010, pp. 173–188 IEEE
-   \[65\] Jason Wei et al. “Chain-of-Thought Prompting Elicits Reasoning in Large Language Models” arXiv, 2022 DOI: [10.48550/ARXIV.2201.11903](https://dx.doi.org/10.48550/ARXIV.2201.11903)
-   \[66\] Kyle Wiggers “Microsoft and NVIDIA Team Up to Build New Azure-Hosted AI Supercomputer” In _TechCrunch_, 2022 URL: [https://techcrunch.com/2022/11/16/microsoft-and-nvidia-team-up-to-build-new-azure-hosted-ai-supercomputer/](https://techcrunch.com/2022/11/16/microsoft-and-nvidia-team-up-to-build-new-azure-hosted-ai-supercomputer/)
-   \[67\] Binhang Yuan et al. “Decentralized Training of Foundation Models in Heterogeneous Environments” arXiv, 2022 DOI: [10.48550/ARXIV.2206.01288](https://dx.doi.org/10.48550/ARXIV.2206.01288)
-   \[68\] Aohan Zeng et al. “GLM-130B: An Open Bilingual Pre-trained Model” arXiv, 2022 DOI: [10.48550/ARXIV.2210.02414](https://dx.doi.org/10.48550/ARXIV.2210.02414)
...
## Appendix B Derivation of Sampling Rate

We provide a derivation of Equation [1](#S3.E1 "In 3.2 How many ML chips does the Verifier need to inspect? ‣ 3 Solution Overview ‣ A template for Arxiv Style Citation: Authors. Title. Pages…. DOI:000000/11111."), the number of samples required for a Verifier to catch a weight snapshot from a rule-violating training run with a given probability $p$. Let $H$ be the size of an ML training run that the Verifier is hoping to catch. Let $C$ be the total number of chips the Prover possesses, and $a$ be the FLOPs/day for those chips. Let $f$ be the expected number of weight-snapshots saved by the chip per day; snapshots are Poisson distributed. The Verifier wants to detect a rule-violating training run of length $T$ that was completed in the last $T_{m}$ days, and will sample $s$ chips every $T_{m}$. We will assume that the Prover executes the training run over the course of $T$ days. (We show in Appendix [C](#A3 "Appendix C Analysis of prover evasion strategies ‣ A template for Arxiv Style Citation: Authors. Title. Pages…. DOI:000000/11111.") that changing $T$ only marginally affects our analysis.)

It is not enough that a chip involved in the training run be sampled by the Verifier; the chip needs to have also logged a weight-snapshot from this particular training run, in order for there to be something for the Verifier to discover. The probability of a chip logging a weight-snapshot is uniform over time (Section [4](#S4 "4 On the chip ‣ A template for Arxiv Style Citation: Authors. Title. Pages…. DOI:000000/11111.")). Assuming the training run began at the beginning of the first monitoring period of length $T_{m}$, the probability that a snapshot was sampled is $1-PoissonCDF_{T;f}(0)=1-e^{-fT}$, where $PoissonCDF_{T;f}$ is the CDF of a Poisson random variable with shape parameter $f$ and interval-length $T$. If the training run lasted multiple monitoring periods, then each later period, each chip is strictly more likely to contain a snapshot than this first period. [^note-shavit-24]
...
There are $\lceil T/T_{m}\rceil$ rounds of sampling for each training run, including the last period (which may not include a full training run, but each chip will still store the relevant weight snapshot hashes).

This means the probability of successfully detecting a snapshot from a large-scale training run within $T_{m}$ days of the training run’s completion is $p=(1-p_{n})^{\lceil T/T_{m}\rceil}$.
...
In Figure [2](#A3.F2 "Figure 2 ‣ C.1 Do the Prover’s odds of evasion benefit from training for longer, across fewer chips? ‣ Appendix C Analysis of prover evasion strategies ‣ A template for Arxiv Style Citation: Authors. Title. Pages…. DOI:000000/11111."), we estimate how $p_{d}(k)$, the probability of detection given a $\times k$ longer run, changes with $k$ and other hyperparameters. For simplicity, we define $b=H/(CaT)$, where we know that $1>b>0$.
...
We want to prove that if the training run uses more chips than necessary $c(t)>c(T)$, each for less time $t<T$, then detection is always more likely $p_{d}(t)\overset{?}{>}p_{d}(T)$.
...
\geq 1-b \\
\frac{1}{t}\left(1-e^{-ft}\right) \\
\geq\frac{1}{T}\left(1-e^{-fT}\right) \\
\frac{H}{aCt}\left(1-e^{-ft}\right) \\
\geq\frac{H}{aCT}\left(1-e^{-fT}\right) \\
...
First, when executing each training run, the Prover follows any required[^note-shavit-25] restrictions on their training (e.g., starting from a subset of valid initializations, or precommitting to the model weights). Throughout training, the Prover saves the hyperparameters (e.g., training code), the sequence of training data batches, and periodic snapshots of the model weights. They also make sure to track any randomness used, and generally make sure their training process is repeatable (up to low-level noise) assuming access to similar but non-identical hardware configurations. This itself is a nontrivial technical challenge \[[33](https://arxiv.org/html/2303.11341#bib.bibx33)\], especially in co-training settings like GANs or RL on learned reward models, and would benefit from further investments in replication tools for common ML frameworks.

Periodically, the Prover reports their chips’ on-chip logged weight-shard snapshot hashes, along with hashed versions of the Proofs-of-Training-Transcript matching each of these logged hashes (including hashes of $\mathbb{M}$, hashes of each model snapshot $\mathbb{W}$, and sequences of hashes of training data points $\mathbb{D}$). The Prover may need to further disclose basic information like the distance between weight-snapshot pairs, which may be needed for the Verifier to determine which regions of the transcript to verify.[^note-shavit-26]

As in Section [3.2](#S3.SS2 "3.2 How many ML chips does the Verifier need to inspect? ‣ 3 Solution Overview ‣ A template for Arxiv Style Citation: Authors. Title. Pages…. DOI:000000/11111."), the Verifier chooses a subset of these chips whose logs will be confirmed via physical inspection. The Verifier inspects the training transcripts and associated metadata, and chooses the subsets of the training transcripts to verify. They also select any other components of the training transcript (e.g., a random sample of the training data) that they will need in order to determine that that the training run has complied with the ML training rules. At this point, the Verifier has a set of hashes of the inputs to its verification protocol (including model weight snapshots and training data points), but does not have access to any of this information directly.
...
[^note-shavit-9]: A possible alternative would be to orchestrate less-frequent snapshots via a Verifier-trusted central server, though this would require a solution to the problem of the Prover swapping out the chip’s weights before propagating the Verifier’s signal.
[^note-shavit-10]: A similar firmware mechanism was used by NVIDIA to enforce cryptocurrency mining limits on its GPUs \[[17](https://arxiv.org/html/2303.11341#bib.bibx17)\].

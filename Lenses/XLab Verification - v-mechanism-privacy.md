...
The solution is **privacy-preserving verification**: mechanisms designed to verify compliance while conveying minimum or zero excess information to verifier parties. Here are previews of privacy-preserving mechanisms. Week 5 examines hardware; Part 2 continues with cloud, intelligence, and human mechanisms:
...
:::callout {title="Secure multiparty computation" tone="neutral" collapse="closed"}
*Diagram: developer and verifier each hold private inputs; a joint computation returns only the agreed result to both.*
...
Week 5 begins with the hardware layer. [[../Lenses/XLab Verification - v-hw-attestation|Section 2.1]] examines how chips can identify themselves, report their state and location, measure workloads, and produce evidence that later cloud and institutional mechanisms can use.

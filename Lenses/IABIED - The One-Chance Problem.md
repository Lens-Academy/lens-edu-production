...
- Chernobyl establishes the denial pattern in experts who are directly in control: managers minimized and denied the danger even as it materialized
- Titanic establishes the denial pattern in public assumptions and design decisions: the "unsinkable" belief prevented adequate preparation
- Together: these two cases make the denial pattern look like a recurring human feature, not an anomaly in one industry or era
- The disanalogy: after both disasters, learning and reform were possible; with ASI, there is no second time

...
content::
\## Reading Assignment
**From *If Anyone Builds It, Everyone Dies*, read *Chapter 14: Where There's Life, There's Hope*.** Start at the phrase
...
- Rishi Sunak (October 2023) and Xi Jinping's "human control" language as early signals of treaty appetite
- Elected officials (persuaded): lay groundwork, bring the issue to colleagues' attention
- Skeptical politicians (not persuaded): require GPU clusters to be concentrated in monitorable centers now, preserving the option to halt later even without fully accepting the risk argument
- Journalists: foreground extinction-risk context behind every AI-company story; name what outside scientists are warning

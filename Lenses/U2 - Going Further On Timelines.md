...
- No grading language of any kind. This is not assessed.

What to do:
1. If they update, reward naming the specific caveat and the direction.
2. If they do not update, take that seriously and ask what would. A student who cannot name anything that would move them has learned something about their own number, and you should say so plainly rather than pushing.

...
---
#### Question
id:: 56d0f1a2-d06f-4c09-ac76-eb36031cd401
content::
\## Before the reading
...
1. Restate the assumption their arithmetic made, in their own terms, as a claim about the remaining work. Usually: the last 84% is made of the same stuff as the first 16%, at the same cost per point.
2. Do not evaluate whether that assumption is true. Say only that it is an assumption and that they made it by dividing.
3. If the student already refused to divide and gave a range or an alternative shape, say so plainly and ask them to write down what their shape assumes instead. Still one turn.

...
content::
\## Reading Assignment
**From *If Anyone Builds It, Everyone Dies*, read *Chapter 6: We'd Lose*,** from the start to
> And because we care about the truth more than about telling you things that are easy to swallow, that's where we'll start.
...
Key concepts:
- The Aztec warrior scenario: a defender watches a Spanish boat far larger than any canoe they've built, its size alone signalling vastly greater capability, even without knowing the specifics
- The skeptic's error: demanding "tell me exactly how they could win, spell out all the details" before accepting the threat, which confuses inability to specify mechanism with inability to predict outcome
- The guns example: "a stick they point at you and you fall over dead" would have sounded like fantasy, yet the warrior who took the threat seriously didn't need to know guns existed in advance
...
- The skeptic's error: "tell me exactly how, spell out all the details" treats inability to name the mechanism as evidence the threat isn't real, yet the Aztecs' inability to imagine guns didn't make guns unreal
